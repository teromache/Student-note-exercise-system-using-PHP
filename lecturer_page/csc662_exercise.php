                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody style="background-color:#fff;">
                                        ...
                                        $query = mysqli_query($db,"SELECT * FROM exercise WHERE subject_name = 'CSC662' AND upload_by='$lect_name'") or die(mysqli_error());
                                        ...
                                        <a href="../lecturer_page/csc662_submission.php?exercise_name=<?php echo $fetch['exercise_name']?>"><button class="btn btn-success"> Submission</button></a>
