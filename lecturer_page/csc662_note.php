            ...
            <div id="layoutSidenav_content">
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody style="background-color:#fff;">
                                        ...
                                        $query = mysqli_query($db, "SELECT * FROM notes WHERE subject_name = 'CSC662'") or die(mysqli_error());
                                        ...
                                        <td><?php echo $fetch['upload_on']?></td>
                                        <td><?php echo $fetch['upload_by']?></td>
                                        <td><?php echo floor($fetch['size'] / 1000) . ' KB'; ?></td>
                                        <td style="text-align:center"><?php echo $fetch['downloads']?></td>
                                        <td style="text-align:center">
                                            <button class="btn btn-danger" data-toggle="modal" type="button" data-target="#delete662_modal<?php echo $fetch['id']?>"><span class="fa fa-trash"></span></button></td>
                                        </tr>
                                        <?php
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        ...
                        <form action="../php/upload_controller/upload_note.php" method="post" enctype="multipart/form-data">

                        <input type="text" name="subject_name" value="CSC662" hidden>
