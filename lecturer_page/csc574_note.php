                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody style="background-color:#fff;">
                                        ...
                                        $query = mysqli_query($db, "SELECT * FROM notes WHERE subject_name = 'CSC574'") or die(mysqli_error());
                                        ...
                                        <td style="text-align:center">
                                            <button class="btn btn-danger" data-toggle="modal" type="button" data-target="#delete_modal<?php echo $fetch['id']?>"><span class="fa fa-trash"></span></button></td>
                                        </tr>
                                        <?php
