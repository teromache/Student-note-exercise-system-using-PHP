                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody style="background-color:#fff;">
                                        ...
                                        require 'dbconn.php';
                                        $query = mysqli_query($db, "SELECT * FROM exercise WHERE subject_name='CSC574'") or die(mysqli_error());
                                        ...
                                        if ($fetch['end_date'] > date("Y-m-d"))
                                        {
                                             ...
                                             echo '&nbsp';
                                             echo '<a href="../student_page/progressCSC574.php?exercise_name='.$fetch['exercise_name'].'"class="btn btn-info">'.' Progress'.'</a>';    
                                             echo '</td>';   
                                        }
                                        else
