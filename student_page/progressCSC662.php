            ...
            <div id="layoutSidenav_content">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Exercise Progress</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="csc574_exercise.php">CSC574 Exercise</a></li>
                            <li class="breadcrumb-item active">Exercise Progress</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody style="background-color:#fff;">
                                        ...
                                        $subject = "CSC662";
                                        require 'dbconn.php';
                                        $query = mysqli_query($db, "SELECT * FROM submission WHERE student_name='$student_name' AND exercise_name='$exercise_name' ") or die(mysqli_error());
                                        ...
                                        <td style="text-align:center">
                                            ...
                                            <button class="btn btn-primary" data-toggle="modal" type="button" data-target="#resubmit_modal<?php echo $fetch['id']?>"><span class="fa fa-upload"></span> Resubmit</button>
